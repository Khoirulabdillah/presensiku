...
<div class="flex items-center justify-center min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8">
    ...
    <!-- CARD FORMULIR -->
    <div class="w-full max-w-4xl bg-white p-8 rounded-xl shadow-2xl transition-all duration-300 hover:shadow-3xl">
        ...
        <form action="{{ route('admin.pegawai.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <!-- KOLOM KIRI - FORM DATA PEGAWAI -->
                <div class="space-y-6">
                    <h3 class="text-lg font-semibold text-gray-700 border-b pb-2">Data Pegawai</h3>
            ...
            <!-- SECTION FOTO WAJAH - FULL WIDTH DI BAGIAN AKHIR -->
            <div class="border-2 border-dashed border-gray-300 rounded-lg p-4 bg-gray-50">
                <h3 class="text-base font-semibold text-gray-700 mb-3">Foto Wajah Referensi</h3>

                <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                    <!-- PREVIEW FOTO -->
                    <div>
                        <label class="block text-xs font-medium text-gray-700 mb-2">Preview</label>
                        <div id="photoPreview" class="rounded-lg overflow-hidden bg-gray-200 flex items-center justify-center" style="height: 220px; aspect-ratio: 3/4;">
                            <div id="photoPlaceholder" class="text-center">
                                <i class="fas fa-image text-gray-400 text-3xl block mb-1"></i>
                                <p class="text-gray-500 text-xs">Belum ada foto</p>
                            </div>
                            <img id="photoImage" src="" alt="Preview Foto" class="hidden w-full h-full object-cover">
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <button type="submit" 
                        class="bg-blue-800 text-white font-semibold py-3 rounded-lg shadow-md hover:bg-blue-700 transition duration-200 ease-in-out transform hover:scale-[1.01] flex items-center justify-center gap-2">
                    <i class="fas fa-plus-circle"></i> Simpan Data Pegawai
                </button>
                
                <a href="{{ route('admin.pegawai.index') }}" 
                   class="flex items-center justify-center bg-gray-200 text-gray-700 font-semibold py-3 rounded-lg shadow-md hover:bg-gray-300 transition duration-200 ease-in-out gap-2">
